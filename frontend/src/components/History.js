...
export default class History extends Component {
    ...
    constructor(props){
        ...
        axios.post('http://localhost:5000/user/getAll', this.state,{ headers: { Authorization:"Bearer " + localStorage.getItem('token') } })
        .then(res =>{
    ...
    //     plans:[{tf:"To: abc.xyz@gmail.com",sub:"this is the subject 1"},{tf:"To: abc.xyz@gmail.com",sub:"this is the subject 1"}]
    // }
